...
namespace U27_Massivi_na_samom_dele
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*int[] result3 = myArray.OrderByDescending(i => i).ToArray();*/ //сортировка массива по убыванию

            /*Array.Sort(myArray);*/ //сортировка массива

           /* int result = Array.Find(myArray, i => i < 70); *///самый первый элемент массива который меньше 70
